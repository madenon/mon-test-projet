...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        @vite(['resources/css/app.css', 'resources/js/app.js','resources/carousel/slick/slick.css','resources/carousel/slick/slick-theme.css','resources/carousel/slick/slick.js','resources/carousel/slick'])
