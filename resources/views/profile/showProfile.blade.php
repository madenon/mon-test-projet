                ...
                <div class="px-6">
                    <div class="flex flex-wrap justify-center">
                        <div class="w-full flex justify-between items-start">
                            ...
                            <div class="col-8 flex justify-center content-start items-end lg:pt-4 pt-8">
                                <div class="p-3 text-center mr-4">                                        <span class="text-lg font-bold block tracking-wide text-slate-700">Trocs en cours</span>
                                ...
                                <div class="p-3 text-center ml-4">                                         <span class="text-lg font-bold block tracking-wide text-slate-700">Trocs realisés</span>
